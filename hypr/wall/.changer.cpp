...
int main(int argc, char* argv[]) {
    ...
    if(argc == 1) {
        ...
        string temp = argv[1];
        if(temp == "random") {
            string toggler = argv[2];
            if(toggler == "true" || toggler == "on" || toggler == "1") {
                exec("echo 1 > random.txt");
            }
            else if(toggler == "false" || toggler == "off" || toggler == "0") {
                exec("echo 0 > random.txt");
            }
            else {
                cout << "Please provide a true/false field." << endl;
                return 1;
            }
        }
        else {
